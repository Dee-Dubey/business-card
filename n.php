...
<head>
        ...
        <!-- Facebook Meta Tags -->
		 <meta property="og:image" content="<?php if(!empty($row['d_logo'])){echo 'https://mybuzinesscard.com/panel/'.str_replace('../','',$row['d_logo_location']);} ?>">
...
if(isset($_POST['email_to_client'])){
        ...
        $headers .= 'From: <info@mybuzinesscard.com>' . "\r\n";
        $headers .= 'Cc: <info@mybuzinesscard.com>' . "\r\n";
...
?>	<br>
		...
		<a href="index.php"><div class="create_card_btn"> Create Your Card @ www.mybuzinesscard.com</div></a>
