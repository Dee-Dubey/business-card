...
<title>Mybuzinesscard|| Digital Visiting Card Online || Business Card Online || Website Developement</title>
...
<!---------Water wave--
	...
	<div class="main_txt">
		<h1>Digital Business Cards for All Business</h1>
		<h2>Our digital business card platform makes designing a card simple, convenient, and reliable. <br>Create what you need in Just 5 minutes </h2>
		<p>THIS IS A DIGITAL BUSINESS CARD THAT IS SMART, ELEGANT & AFFORDABLE.</p>
		
		<a href="panel/login"><div class="btn_1">7 Day Free Trial>></div></a>
	</div>
...
<br>
 ...
 <div class="row display_flex">
		...
		<h1>Freedom from Boring Printed Business Cards</h1>
		
		<h3>
				Design your digital visiting card in just 5 minutes - it's easy, elegant and free. Mybuzinesscard is always in your pocket, never tears and never runs out. Your Digital Visiting Card can be easily updated with our user-friendly dashboard, so you won't need to re-print a business card again.</h3>
	...
	<iframe style="width: 100%; height: 350px;" src="https://www.youtube.com/embed/W9gapO17ENE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<div class="wtsp_chat">
	<a href="https://api.whatsapp.com/send?phone=919867497641&text=I%20am%20Interested%20in%20Digital%20Business%20Card/%20Mini%20Website%20on%20www.mybuzinesscard.com&source=&data=&app_absent=" target="_blank"><img src="images/wtsp.png" alt="Live Chat"></a>
</div>
...
<div class="row row_backimg">
	...
	<div class="flex_box">
		...
		<p>Design your digital visiting card in just 5 minutes</p>
	...
	<div class="flex_pricing">
		...
		<div class="flex_pricingin">
			...
			<ul>
				...
				<li ><i class="fa fa-check"></i>20 Ecommerce Online Store </li>
...
<div class="temp_preview">
	...
	<div class="temp_pre"><img src="panel/images/template1.png"><a href="https://www.mybuzinesscard.com/Digital-Infinite-1" target="_blank"><div class="pre_btn">Select</div></a></div>
	<div class="temp_pre"><img src="panel/images/template2.png"><a href="https://www.mybuzinesscard.com/Digital-Infinite-14
"><div class="pre_btn">Select</div></div>
	
	<div class="temp_pre"><img src="panel/images/template3.png"><a href="https://www.mybuzinesscard.com/Digital-Infinite-4" target="_blank"><div class="pre_btn">Select</div></a></div>
	<div class="temp_pre"><img src="panel/images/template.png"><a href="https://www.mybuzinesscard.com/Digital-Infinite-6" target="_blank"><div class="pre_btn">Select</div></a></div>
	<div class="temp_pre"><img src="panel/images/template4.png"><a href="https://www.mybuzinesscard.com/Digital-Infinite-3" target="_blank"><div class="pre_btn">Select</div></a></div>
	<div class="temp_pre"><img src="panel/images/template5.png"><a href="https://www.mybuzinesscard.com/Digital-Infinite-2" target="_blank"><div class="pre_btn">Select</div></a></div>
	<div class="temp_pre"><img src="panel/images/template7.png"><a href="https://www.mybuzinesscard.com/Digital-Infinite-5" target="_blank"><div class="pre_btn">Select</div></a></div>
	<div class="temp_pre"><img src="panel/images/template8.png"><a href="https://www.mybuzinesscard.com/Digital-Infinite-" target="_blank"><div class="pre_btn">Select</div></a></div>
	<div class="temp_pre"><img src="panel/images/template9.png"><a href="https://www.mybuzinesscard.com/Digital-Infinite-7" target="_blank"><div class="pre_btn">Select</div></a></div>
	<div class="temp_pre"><img src="panel/images/template10.png"><a href="https://www.mybuzinesscard.com/Digital-Infinite-12" target="_blank"><div class="pre_btn">Select</div></a></div>

	<div class="temp_pre"><img src="panel/images/template11.png"><a href="https://www.mybuzinesscard.com/Digital-Infinite-11" target="_blank"><div class="pre_btn">Select</div></a></div>
	<div class="temp_pre"><img src="panel/images/template12.png"><a href="https://www.mybuzinesscard.com/Digital-Infinite-10" target="_blank"><div class="pre_btn">Select</div></a></div>
	<div class="temp_pre"><img src="panel/images/template13.png"><a href="https://www.mybuzinesscard.com/Digital-Infinite-9" target="_blank"><div class="pre_btn">Select</div></a></div>
	<div class="temp_pre"><img src="panel/images/template14.png"><a href="https://www.mybuzinesscard.com/Digital-Infinite-13" target="_blank"><div class="pre_btn">Select</div></a></div>
	<div class="temp_pre"><img src="panel/images/template15.png"><a href="https://www.mybuzinesscard.com/Digital-Infinite-8" target="_blank"><div class="pre_btn">Select</div></a></div>
...
<div class="row33">
	<h1>Digital Card is Beneficial for</h1>
...
<div class="w_l_f" id="start_business">
	<h1>White Label Franchise/Reseller/Website</h1>
	
	<img src="images/ladder-clipart-business-1.png">
	<ul>
		<li>Custom Domain Name</li>
		<li>Create Unlimited Cards</li>
		<li>No Commission On Cards</li>
		<li>Customised Home Page</li>
		<li>Payment Gateway for Direct Payment</li>
		<li>IT Support Available</li>
		
	</ul>
<a href="https://api.whatsapp.com/send?phone=919867497641&text=I am Interested in Whitelabel Reselling Franchisee for Mini Website&source=&data=&app_absent">
<div class="btn_2">Enquiry Now</div></a>
</div>

<div class="row_contact">
	<h3>RESELLER, CONTACT US <br>
	FOR GOOD PROFITABLE BUSINESS</h3>

    <a href="tel:9867497641"><div class="btn_1">Call Now>></div></a>
...
<div class="services" id="services" >
	...
	<div class="services_box" onclick="location.href='#contact'"><h3>Digital Visiting Card</h3><p>Still using old boring visiting cards? Now its time to change. Use our Online Visiting Card service and GO DIGITAL.</p><div class="pre_btn">Select</div></div>
	<div class="services_box" onclick="location.href='https://api.whatsapp.com/send?phone=919867497641&text=Website Developement&source=&data=&app_absent'"><h3>Website Design/Developement</h3><p>Design your own Business/Professional website in just 5,999 Rs only.</p><div class="pre_btn">Select</div></div>
	<div class="services_box" onclick="location.href='#contact'"><h3>Digital Marketing</h3><p>Advertise online and expand your business. </p><div class="pre_btn">Select</div></div>
	<div class="services_box" onclick="location.href='#contact'"><h3>Logo Designing</h3><p>Best logo disigners available to design your business/professional logo.</p><div class="pre_btn">Select</div></div>
...
<div class="row_bottom display_flex" id="contact">
	...
	<div class="side1">
		...
		<h1>Mybuzinesscard</h1>
		
		<h3>Contact Details</h3>

		<div class="row_bt_p"><i class="fa fa-map-marker"></i><h4> Mumbai-421201, Maharashtra,India</h4></div>
		
		<div class="row_bt_p"><i class="fa fa-phone"></i> <h4>+91 9867497641</h4></div>
		<div class="row_bt_p"><i class="fa fa-envelope"></i><h4>mybuzinesscard@gmail.com</h4></div>
		
		<a href="https://www.facebook.com/MyBuzinessCard" target="_blank"><img class="join_facebook" src="images/join1.png"></a>
		<a href="https://www.youtube.com/channel/UCOR775A3urwFkDdFRG2qu_Q" target="_blank"><img class="join_facebook" src="images/youtube_channel.png"></a>
...
<p>Copyright 2020 || www.mybuzinesscard.com</p>
