	...
	<?php
		...
		if(mysqli_num_rows($query)==1){
			...
			<div class="verify_details">
					...
					<div><p><b>Amount:</b> </p><p><?php if($row['d_payment_amount'] < 499 ){echo $_SESSION['amount']='499'; echo ' Rs';} else {$row['d_payment_amount'];}?></p></div>
			...
			<div class="verify_details">
					...
					<div><p><b>Name:</b></p><p><?php echo $_SESSION['user_name']=$row['d_f_name'].$row['d_l_name'];?></p></div>
					<div><p><b>Contact:</b> </p><p><?php echo $_SESSION['user_contact']=$row['d_contact'];?></p></div>
					<div><p><b>Amount:</b> </p><p><?php if($row['d_payment_amount'] < 499 ){echo $_SESSION['amount']='499'; echo ' Rs';} else {$row['d_payment_amount']; echo 'Rs.';}?></p></div>
